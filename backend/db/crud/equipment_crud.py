...
from backend.db.models.equipment_model import InstalledEquipment
from backend.db.schemas.equipment_schema import InstalledEquipmentCreate, InstalledEquipmentUpdate
